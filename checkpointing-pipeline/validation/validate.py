...
CONFIG = {
    ...
    "sdpa_backend": "auto",                  # set "math" if training still segfaults:
                                             # disables fused attention kernels (same math)
    "pin_memory": False,                     # off: skip pinned-host-memory staging — a
                                             # classic native crash site on suspect RAM;
                                             # cost is a marginally slower host->GPU copy
